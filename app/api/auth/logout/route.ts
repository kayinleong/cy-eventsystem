...
// NOTE: Server-side "session expired" redirects use /api/auth/expire-session
// (NOT a GET on /api/auth/logout) because auth-edge's authMiddleware intercepts
// this logoutPath and short-circuits any custom GET handler we'd add here.
// See app/api/auth/expire-session/route.ts.
